package com.vladproduction._1_thread_and_concurrency;

/**
 * Daemon Thread is:
 * Infrastructure threads that run in the background, performing tasks like garbage collection or GUI event dispatching, are know as daemon threads.
 * */
