...
public class ExecutionSchedulingDemo {
    public static void main(String[] args) throws InterruptedException {
        ...
        int person1CountVegetables = person1.vegetableCount;
        int person2CountVegetables = person2.vegetableCount;
        System.out.printf("%s winner!", person1CountVegetables > person2CountVegetables ?  person1.getName() : person2.getName());
    }
}
