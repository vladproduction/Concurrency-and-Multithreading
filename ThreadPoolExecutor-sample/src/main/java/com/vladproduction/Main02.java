...
public class Main02 {
    public static void main(String[] args) {
        ...
        ThreadPoolExecutor configurableThreadPool = new ThreadPoolExecutor(1, 10,
        ...
        for (int i = 0; i < 10; i++) {
            ...
            try{
                ...
                configurableThreadPool.execute(new Thread(runnable1));
                System.out.println("\tafter execute#1");


                System.out.println("\tbefore execute#2");
                configurableThreadPool.execute(new Thread(runnable2));
                System.out.println("\tafter execute#2");


                System.out.println("\tbefore execute#3");
                configurableThreadPool.execute(new Thread(runnable3));
